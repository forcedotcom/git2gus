...
describe('createComment github service', () => {
    ...
    it('should call createComment with token client for SSO Org in an issue', async () => {
        const req = {
            body: {
                issue: {
                    number: 30
        ...
        expect(
            req.octokitTokenClient.issues.createComment
    ...
    it('should call createComment with token client for SSO enabled org in an pull request', async () => {
        const req = {
            body: {
                pull_request: {},
                number: 35,
